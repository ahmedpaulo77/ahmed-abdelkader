import { useScrollReveal, useSlideReveal, useScaleReveal } from '../hooks/useScrollReveal';
import './About.css';
import doctorImg from '../images/2.jpg';

function About() {
  const imageRef  = useSlideReveal('left');
  const contentRef = useSlideReveal('right');
  const badgeRef  = useScaleReveal();
      ...
      <div className="container">
        <div className="about__grid">
          ...
          <div className="about__image" ref={imageRef}>
            ...
            <div className="about__experience-badge" ref={badgeRef}>
              <strong>+15</strong>
              <span>سنة خبرة</span>
            </div>
          </div>
