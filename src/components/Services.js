...
const services = [
  ...
  },
  {
    ...
    messageKey: 'diet',
    details: {
      fullDesc: 'السمنة مرض وليست عيب! في Hayah Clinic نتعامل معها بجدية طبية كاملة من خلال بروتوكولات علاجية متكاملة تشمل التغذية العلاجية والتقنيات الطبية الحديثة تحت إشراف مباشر من د. أحمد مجدي.',
      benefits: [
